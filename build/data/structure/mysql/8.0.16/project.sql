...
CREATE TABLE `drn_customer_and_supplier` (
    `drn_customer_and_supplier_id` smallint unsigned NOT NULL AUTO_INCREMENT,

    `apellidoynombreorazonsocial` varchar(255) NOT NULL,
    `iscustomer` tinyint NOT NULL,
    `issupplier` tinyint NOT NULL,
    `name` varchar(255) NOT NULL,
    `numerodecuit` int unsigned NOT NULL,
    `slug` varchar(255) NOT NULL,
    `tipodecuit` tinyint unsigned NOT NULL,
...
CREATE TABLE `drn_localidad` (
    `drn_localidad_id` smallint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `drn_site` (
    `drn_site_id` smallint unsigned NOT NULL AUTO_INCREMENT,

    `address` varchar(255) NOT NULL,
    `denominacionadicional` varchar(255) NOT NULL,
    `drn_customer_and_supplier_id` smallint unsigned NOT NULL,
    `drn_localidad_id` smallint unsigned NOT NULL,
...
CREATE TABLE `drn_purchase` (
    `drn_purchase_id` smallint unsigned NOT NULL AUTO_INCREMENT,

    `drn_site_id` smallint unsigned NOT NULL,
    `name` varchar(255) NOT NULL,
...
CREATE TABLE `drn_purchase_event` (
    `drn_purchase_event_id` smallint unsigned NOT NULL AUTO_INCREMENT,

    `details` text NOT NULL,
    `drn_purchase_id` smallint unsigned NOT NULL,
...
CREATE TABLE `drn_purchase_event_status` (
    `drn_purchase_event_id` smallint unsigned NOT NULL,
...
CREATE TABLE `drn_purchase_event_user` (
    `drn_purchase_event_id` smallint unsigned NOT NULL,
    `vxn_user_id` smallint unsigned NOT NULL,
...
CREATE TABLE `drn_file` (
    `drn_file_id` smallint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `drn_purchase_event_file` (
    `drn_file_id` smallint unsigned NOT NULL,
    `drn_purchase_event_id` smallint unsigned NOT NULL,
...
CREATE TABLE `drn_commercial_document` (
    `drn_commercial_document_id` smallint unsigned NOT NULL AUTO_INCREMENT,

    `date` date NOT NULL,
    `exempt` decimal(11,2) NOT NULL,
    `letter` enum('A','B','C') NOT NULL,
    `net105` decimal(11,2) NOT NULL,
    `net21` decimal(11,2) NOT NULL,
    `number` int unsigned NOT NULL,
    `othertaxes` decimal(11,2) NOT NULL,
    `puntodeventa` mediumint unsigned NOT NULL,
    `total` decimal(11,2) NOT NULL,
    `type` enum('Credit note','Debit note','Invoice') NOT NULL,
    `uuid` binary(16) NOT NULL,
    `vat105` decimal(11,2) NOT NULL,
    `vat21` decimal(11,2) NOT NULL,
...
CREATE TABLE `drn_invoice_balance` (
    `drn_commercial_document_id` smallint unsigned NOT NULL,
...
CREATE TABLE `drn_invoice_note` (
    `drn_invoice_id` smallint unsigned NOT NULL,
    `drn_note_id` smallint unsigned NOT NULL,
...
CREATE TABLE `drn_purchase_balance` (
    `drn_purchase_balance_id` smallint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `drn_purchase_category` (
    `drn_purchase_category_id` tinyint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `drn_purchase_invoice_category` (
    `drn_commercial_document_id` smallint unsigned NOT NULL,
    `drn_purchase_category_id` tinyint unsigned NOT NULL,
...
CREATE TABLE `drn_purchase_invoice_note_category` (
    `drn_invoice_note_drn_invoice_id` smallint unsigned NOT NULL,
    `drn_invoice_note_drn_note_id` smallint unsigned NOT NULL,
    `drn_purchase_category_id` tinyint unsigned NOT NULL,
...
CREATE TABLE `drn_purchase_balance_category` (
    `drn_purchase_balance_id` smallint unsigned NOT NULL,
    `drn_purchase_category_id` tinyint unsigned NOT NULL,
...
CREATE TABLE `drn_purchase_payment` (
    `drn_purchase_payment_id` smallint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `drn_purchase_invoice_payment` (
    `drn_commercial_document_id` smallint unsigned NOT NULL,
    `drn_purchase_payment_id` smallint unsigned NOT NULL,
